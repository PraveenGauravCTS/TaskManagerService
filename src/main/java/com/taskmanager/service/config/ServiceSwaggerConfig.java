package com.taskmanager.service.config;
...
public class ServiceSwaggerConfig {
    ...
    @Bean
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.taskmanager.service.rest")).paths(PathSelectors.any()).build();
    }
